  ...
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col
     items-center justify-center gap-4'>
        ...
        <h3 className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-ovo'>Hai, I'm Listya Dwi Subagya 
            <Image alt='' src={assets.hand_icon} className='w-6'/></h3>

        <h1 className='text-3xl sm:text-6xl lg:text-[66px] font-ovo'>
            frontend web developer based in Indonesia.
        </h1>
            <p className='max-w-2xl mx-auto font-ovo'>I am frontend developer from yogyakarta, Indonesia with pasionate in website development</p>
        ...
        <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
            ...
            <Image alt='' src={assets.right_arrow_white} className='w-4'/></a>
