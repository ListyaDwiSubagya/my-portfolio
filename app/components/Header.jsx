  ...
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col
     items-center justify-center gap-4'>
        ...
        className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-ovo'>Hai, I'm Listya Dwi Subagya 
            <Image alt='' src={assets.hand_icon} className='w-6'/></motion.h3>
        ...
        className='max-w-2xl mx-auto font-ovo'>I am frontend developer from yogyakarta, Indonesia with pasionate in website development</motion.p>
