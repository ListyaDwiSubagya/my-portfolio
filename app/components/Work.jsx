  ...
  return (
    ...
    id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        className='text-center max-w-2xl mx-auto mt-5 mb-12 font-ovo'>
            Wellcome to my web development portfolio! Explore a collection of projects
...
>
    {workData.map((project, index) => (
        ...
        href="#work" className='w-max flex items-center justify-center gap-2 text-gray-700 
        border-[0.5px] rounded-full py-3 px-10 mx-auto my-20 hover:bg-lightHover duration-500
